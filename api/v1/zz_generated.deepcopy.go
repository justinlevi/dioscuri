...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressMigratePaths) DeepCopyInto(out *IngressMigratePaths) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressMigratePaths.
func (in *IngressMigratePaths) DeepCopy() *IngressMigratePaths {
	if in == nil {
		return nil
	}
	out := new(IngressMigratePaths)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IngressMigrateSpec) DeepCopyInto(out *IngressMigrateSpec) {
	*out = *in
	out.IngressPaths = in.IngressPaths
}
